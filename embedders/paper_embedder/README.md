...
This directory contains a Jupyter Notebook (`paper_embedder.ipynb`) that implements a complete pipeline for generating embeddings for scientific papers.
...
## Workflow (Chunking and Fault Tolerance)
