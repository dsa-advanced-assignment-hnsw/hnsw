              ...
              >
                ...
                <div className="flex items-end justify-between mt-auto pt-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Link href="https://www.linkedin.com/in/huy-nguy%E1%BB%85n-%C4%91%C3%ACnh-b9511035b/" className="w-9 h-9 bg-black rounded-full flex items-center justify-center hover:scale-110 transition-transform">
                      <Linkedin className="w-4 h-4 text-white" />
                    </Link>
                  </div>
                </div>
